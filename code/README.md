`clean_vlm_pipeline` Contains a notebook that goes from a properly formatted CSV to keyframes and audio. Also has a generic version of the script used to run a VLM. Most organized and presentable code.
